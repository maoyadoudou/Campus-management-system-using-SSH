		...
		$.post(url,param,function(data){
			if(data != null){
				$.each(data,function(k,v){
					...
					var courseTeacherName = v.course_teacher;
...
//						alert(week_number_word);
					var course_content =  '<TR id=course_tr_' + courseId + ' class=coursescore_list_body>\
											...
											<td id=courseTeacher_' + courseId + 'name=teacher_name>' + courseTeacherName + '</td>\
											<td id=courseName_' + courseId + 'name=course_score>' + courseScore + '</td>\
                                          </TR>';
